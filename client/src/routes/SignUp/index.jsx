...
//             <span className="font-extrabold">Sign up</span> for an account
//           </h1>
...
//               <Link
//                 to="/signin"
//                 className="underline underline-offset-4 font-medium text-primary-600 hover:underline dark:text-primary-500"
//               >
//                 Login now
//               </Link>
//             </p>
...
import { Link, useLocation, useNavigate } from "react-router-dom";
import { useRegisterMutation } from "../../utils/slices/userApiSlice";
